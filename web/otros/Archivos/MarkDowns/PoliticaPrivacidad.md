...
- **Foto de perfil** (opcional, solo para mostrar a los ganadores de rifas.)
...
- Mostrar tu foto de perfil únicamente si resultas ganador de una rifa.

---

## 4. Base Legal
- **Ejecución de contrato o precontrato**: para procesar compras o participaciones en rifas.  
- **Consentimiento explícito**: para usar tu foto de perfil en rifas; puedes retirarlo en cualquier momento sin afectar tu participación o compra.

---

## 5. Almacenamiento y Seguridad
Tus datos se almacenan de forma segura y no se comparten con terceros, salvo cuando sea requerido por la ley.
...
Esta política puede actualizarse; los cambios se publicarán en esta página con la fecha de última actualización.
