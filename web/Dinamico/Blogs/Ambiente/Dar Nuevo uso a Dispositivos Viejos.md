Vivimos en un mundo donde se venden dispositivos con obsolesencia artificial, iPhones que dejan de actualizarse por cosas irrelevantes y ya no te dejan instalar aplicaciones basicas
<img width="750" height="685" alt="ios17" src="https://github.com/user-attachments/assets/85bc813a-9312-44ed-9bfc-da0461a7aad8" />
...
Muchos de estos dispositivos la empresa prohibe que se puedan seguir actualizando de manera comunitaria, apple no permite el desbloqueo del bootloader ni da fuentes de drivers, no hay manera de reutilizarlos. Algunos iPhones viejos como el iPhone X e inferior aun se le puede hacer Jailbreak por una falla de seguridad, no por que haya estado pensado para eso, y en esos casos aun se puede reutilizar.

### No a la Obsolecencia Artificial
Recuerda no apoyar estas malas practicas, compra marcas que si tienen metodos de desbloqueo [listadas aqui ](https://github.com/zenfyrdev/bootloader-unlock-wall-of-shame#%EF%B8%8F-proceed-with-caution) (mas arriba de la lista se ven marcas a evitar por que hacen practicas de obsolecencia artifical)
...
### iOS 
En caso de tener un iPhone antiguo puedes ir a [Esta pagina Web](https://jailbreaks.app/) si arriba aparece un led verde puedes hacer Jailbreak con solo un clic... Si eso no funciona aun hay otros metodos pero requieren de una PC. 
